...
To interactively explore the database and its contents, you can run Drizzle Kit studio:
...
- View, sort and filter data
- Run SQL statements
- Debug queries and data issues
- Export CSV/JSON/XLSX

### Manual Data Collection (Legacy)
